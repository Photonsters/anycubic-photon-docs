...
These look-alike Photons (or Faux Photons / Fauxtons) most probably share the same mainboards with the Photon-S and can only print proprietary *.pws files. These are Photons in look only, they are incompatible with the original Photons shipped between October 2017 to early October 2019. 
