...
### I know what I'm doing and didn't bother reading all that text, I still can't get a print! 
If you're absolutely sure you've got your build plate leveled perfectly and you still can't get a print, [try following these steps very carefully.](https://github.com/Photonsters/anycubic-photon-docs/blob/master/FAQ.md#whats-this-leveling-that-i-keep-hearing-about)
...
This is the amount of time that the UV light is turned off during the end of one exposure cycle. After an exposure, the UV light turns off, the build plate lifts and peels, then descends ready for the next cycle and will wait at the bottom (resting down on the FEP sheet, at the bottom of your vat) before the UV light comes on again for the next exposure. Longer times leave more time for the resin to settle out and form a new layer with fresh resin. If unsure, leave the value at 1, your printer will then default to the firmware settings, usually 6.5 secs for older printers or firmware, 4.5 secs for newer printers or firmware. 
...
Yes, you can leave finished prints for as long as you need before removing and post processing. Just like leaving resin in the vat, as long as it's kept away from light, it's safe to leave it for long periods of time. 
