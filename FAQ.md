...
All new Photons come with Yellow windows. As of January 1st, 2019 all Photons ship with Yellow windows. Older machines had Blue windows. Blue [doesn't block UV well](https://www.facebook.com/groups/AnycubicPhoton/permalink/1287895011355138/) and they were changed to yellow later, with slight revisions to uncap the top end of the Z lead screw and include a better PSU. 
...
**Remember** that as you tighten the setting (grub) screw it will move the plate down a tiny fraction more. You will find that you cannot pull the paper anymore, so you should raise / backoff the build plate level by 0.01mm increments until the plate is gripping the paper with even resistance, and that you can pull but not push it back. Then only set Z=0.
...
[[[https://github.com/Photonsters/anycubic-photon-docs/blob/master/temp/rsz_plate_texture.png|alt=texture]]
