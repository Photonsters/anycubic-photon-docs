...
This is the amount of time the build plate will wait at the bottom of a cycle (resting down on the FEP sheet, at the bottom of your vat) before the UV light comes on for the next exposure. Longer times leave more time for the resin to settle out and form an layer with fresh resin. If unsure, leave the value at 1, your printer will then default to the firmware settings, usually 6.5 secs for older printers or firmware, 4.5 secs for newer printers or firmware. 
