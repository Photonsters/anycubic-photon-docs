...
When your print peels from the FEP film, there are a lot of suction forces involved. Unlike more expensive machines, the Photon does not have a tilt peel mechanism, relies on the flexibility of the FEP film to provide a clean peel. A correctly tensioned FEP therefore will give the best print results and avoid failures or delamination problems. 
